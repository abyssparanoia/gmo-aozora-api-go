 ...
 * @param xAccessToken アクセストークン  minLength: 1 maxLength: 128 
 * @param optional nil or *TransferApiTransferStatusUsingGETOpts - Optional Parameters:
...
type TransferApiTransferStatusUsingGETOpts struct {
...
func (a *TransferApiService) TransferStatusUsingGET(ctx context.Context, accountId string, queryKeyClass string, xAccessToken string, localVarOptionals *TransferApiTransferStatusUsingGETOpts) (TransferStatusResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
