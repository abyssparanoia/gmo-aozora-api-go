 ...
 * @param optional nil or *AccountApiAccountsDepositTransactionsUsingGETOpts - Optional Parameters:
...
type AccountApiAccountsDepositTransactionsUsingGETOpts struct {
    DateFrom optional.String
    DateTo optional.String
    NextItemKey optional.String
}

func (a *AccountApiService) AccountsDepositTransactionsUsingGET(ctx context.Context, accountId string, xAccessToken string, localVarOptionals *AccountApiAccountsDepositTransactionsUsingGETOpts) (DepositTransactionsResponse, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xAccessToken アクセストークン  minLength: 1 maxLength: 128 
 * @param optional nil or *AccountApiBalancesUsingGETOpts - Optional Parameters:
     * @param "AccountId" (optional.String) -  口座ID 口座を識別するID  minLength: 12 maxLength: 29 
@return BalancesResponse
*/

type AccountApiBalancesUsingGETOpts struct {
    AccountId optional.String
}

func (a *AccountApiService) BalancesUsingGET(ctx context.Context, xAccessToken string, localVarOptionals *AccountApiBalancesUsingGETOpts) (BalancesResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param xAccessToken アクセストークン  minLength: 1 maxLength: 128            
 * @param optional nil or *AccountApiTransactionsUsingGETOpts - Optional Parameters:
     * @param "DateFrom" (optional.String) -  対象期間From 半角文字 YYYY-MM-DD形式  minLength: 10 maxLength: 10 
     * @param "DateTo" (optional.String) -  対象期間To 半角文字 YYYY-MM-DD形式 対象期間Fromと対象期間Toを指定する場合は、対象期間From≦対象期間Toとし、それ以外は「400 Bad Request」を返却  minLength: 10 maxLength: 10 
...
type AccountApiTransactionsUsingGETOpts struct {
    DateFrom optional.String
    DateTo optional.String
    NextItemKey optional.String
}

func (a *AccountApiService) TransactionsUsingGET(ctx context.Context, accountId string, xAccessToken string, localVarOptionals *AccountApiTransactionsUsingGETOpts) (TransactionsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
